...
<%--                            }--%>
 ...
 function queryData4(type){ 
	if (type==2){//重置
		...
		$("#figure4").load("grqueryArea.action",{'beginTime':x,'endTime':y,'area':q,'level':p});
	}else{
		var chart = echarts.init(document.getElementById('figure4'),theme);
		...
		$("#figure4").load("grqueryArea.action",{'beginTime':$('#beginTime2').datebox('getValue'),'endTime':$('#endTime2').datebox('getValue'),'area':r,'level':$('#level1 option:selected') .val()});
	}
};
</script>
...
<div style="width:auto;height:auto;padding-top:20px;overflow: auto;">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	辖区名称：   <input class="easyui-combotree" id="area" name="area" value="${area.name}" data-options="url:'loadArea.action',method:'post',multiple:true" style="width:260px;"></input>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;开始时间：<input type="text" class="easyui-datebox" editable="false" name="beginTime2" id="beginTime2" style="width:120px;"/>
 		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;结束时间：<input type="text" class="easyui-datebox" editable="false" name="endTime2" id="endTime2" style="width:120px;"/>
