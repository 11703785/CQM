...
<form id="orgFormedit" method="post">
	...
	<table class="applytable" cellspacing="0" cellpadding="8" align="center">
		<tr>
	        ...
	        <td class="applytdnotcolor"><input id="organizationname" value="${organization.organizationname}" name="organization.organizationname"  class="easyui-textbox" data-options="prompt:'输入机构名称...',required:true,validType:['length[1,50]']" style="width:220px;height:32px"> </td> 
...
<div style="text-align:center;padding:10px">
	<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="Organization.submitedit()">提交</a>&nbsp;&nbsp;
