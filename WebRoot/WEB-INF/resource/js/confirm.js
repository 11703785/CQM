var Confirm = {
    ...
    init: function(size) {
        ...
        ElemHtml = '<div id="confirm-modal" class="modal fade role="dialog" tabindex="-1">' + 
        			...
        			'<button id="modal-upper-close" class="close modal-close" aria-label="Close" type="button">' + '<span aria-hidden="true">×</span>' + '</button>' + 
        			'<h4 id="modal-title" class="modal-title">Modal Title</h4>' + '</div>' + 
