...
public class ResultResponse<T> {
	 ...
	 * @param accNum 请求队列数量
	 */
	public void setAccNum(final Integer accNum) {
		this.accNum = accNum;
	}
	 ...
	 */
	public void setQueryFrequency(final Integer queryFrequency) {
	 ...
	 */
	public void setStaNumb(final Integer staNumb) {
	 ...
	 * @param margin 弹窗状态码
	 */
	public void setStaNum(final Integer i) {
		this.staNum = i;
	}
	 ...
	 * @param d 超过阈值百分比
	 */
	public void setOverlimit(final double d) {
		this.overlimit = d;
	}
