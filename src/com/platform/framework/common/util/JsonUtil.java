...
public class JsonUtil {
	...
	public static String fromMapLists(Collection colls, Map map) throws SecurityException,NoSuchFieldException, JSONException {
		StringBuffer jsons = new StringBuffer();
		if (CollectionUtil.isEmpty(colls)) {
			jsons.append("{"); // json 最外层括号 start
			String propertys = (String) map.get("totalProperty");
		...
		jsons.append(fromArray(colls.toArray()));
